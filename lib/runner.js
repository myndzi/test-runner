...
function Runner(opts, baseDir) { // jshint ignore: line
    ...
    this._perf = opts._perf || function () { throw new Error('No performance function supplied'); };
    ...
    .forEach(function (type) {
        ...
        this.opts[type].logLevel = opts[type].logLevel || opts.logLevel;
        this.opts[type].doReport = opts[type].doReport || opts.doReport;
        this.opts[type].reportDir = opts[type].reportDir || opts.reportDir;
    }, this);
...
Runner.prototype.run = Promise.method(function () {
    ...
    return Promise.each(['mocha', 'coverage', 'perf', 'lint'], function (type) {
        ...
        mocha = self._mocha(self.opts.mocha, self), istanbul;
        ...
        return Promise.each(Object.keys(fileSets), function (key) {
            ...
            return Promise.try(function () {
                ...
                return mocha(files, ctx, PATH.relative(self.baseDir, key));
            }).tap(function () {
                if (self.doCov) {
